...
public class MainActivity extends AppCompatActivity {
    ...
    private final int LARGE_FONT = 18; // Размер шрифта для режима крупного шрифта
    private final int SMALL_FONT = 15; // Размер шрифта для режима обычного шрифта
            ...
            public void afterTextChanged(Editable s) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        final String data = db.getData(filter, checkBox1.isChecked(), checkBox2.isChecked(), checkBox3.isChecked(), checkBox4.isChecked(), checkBox5.isChecked(), checkBox6.isChecked());
